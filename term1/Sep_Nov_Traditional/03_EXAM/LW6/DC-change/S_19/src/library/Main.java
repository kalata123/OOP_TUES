...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Harry Poter", "J.K. Rowling", "1234567890");
        ...
        Member member1 = new Member("John Doe", "1234567890");
        ...
        //System.out.println(book1.author); ne raboti
        // HINT: Show LibrarySettings usage
        // Print the maximum borrow limit constant
        // Generate some item IDs using the static method
        System.out.println(LibrarySettings.MAX_BORROWED_LIMIT);
        System.out.println(LibrarySettings.generateRandomId("BOOK"));
