...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book book = new Book("Book 1", "Me", "123");
        Book book2 = new Book("Book 2", "Me");
        ...
        Member member2 = new Member("John Wick");
...
//        System.out.println(membe1.name); -> doesnt work
        ...
        System.out.println("MAX" + MAX_BORROW_LIMIT);
        System.out.println("ID " + generateItemId("Hi"));
